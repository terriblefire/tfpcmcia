...
/* RISC-V Vector (RVV) CSR helpers. The bundled MRS GCC 8.2 assembler does
 * not know the V-extension CSRs and this firmware does not use RVV, so
 * they are compiled out. Define CORE_RISCV_ENABLE_RVV_CSR with a
 * V-extension-aware toolchain to restore them. */
#ifdef CORE_RISCV_ENABLE_RVV_CSR
/*********************************************************************
 * @fn      __get_VXRM
 *
...
#endif /* CORE_RISCV_ENABLE_RVV_CSR */
