...
#define SPI_DATA   (*(volatile UBYTE*)0xA00200)
#define SPI_CS     (*(volatile UBYTE*)0xA00202)
#define SPI_STATUS (*(volatile UBYTE*)0xA00204)
#define BOARD_CTRL (*(volatile UBYTE*)0xA00206)
